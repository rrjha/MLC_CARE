...
LIST="soplex zeusmp GemsFDTD gobmk bzip2 lbm leslie3d mcf omnetpp perlbench cactusADM hmmer sphinx3 sjeng"
...
#	sed '5q;d' 'mix_encodingNLRU_LW'$ds'_r4_trace-'$a'_16M_32way_f0_t12.txt'	| 	awk '{printf "%5.2f\t", $4} END {if(!NR) printf "%9s\t", " "}' 
	...
	do
		...
		grep  "system.l3.tags.total_Reps::273" $a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
		grep  "system.l3.tags.total_ZT::273" $a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
		grep  "system.l3.tags.total_ST::273" $a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
		grep  "system.l3.tags.total_HT::273" $a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
		grep  "system.l3.tags.total_TT::273" $a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}'
...
#		ds="options_3"
#		printf "two_step\t" 
#		grep  "system.l3.tags.total_Reps::total" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
#		grep  "system.l3.total_trans::0" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
#		grep  "system.l3.total_trans::1" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
#		grep  "system.l3.total_trans::2" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}' 
#		grep  "system.l3.total_trans::3" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%5.0f\t", $2} END {if(!NR) printf "%9s\t", " "}'
#		grep  "system.l3.overall_miss_rate::total" ../../gem5_twostep/rest/$a/$ds/stats.txt	| 	awk '{printf "%1.6f\t", $2} END {if(!NR) printf "%9s\t", " "}'
