...
LIST="astar soplex zeusmp GemsFDTD gobmk bzip2 lbm leslie3d mcf omnetpp perlbench cactusADM sphinx3 sjeng"
...
#	done
DESIGN="options_8 options_9 options_12 options_10"
#echo "                                       mlc                                        lru"
for a in $LIST
do
	printf "%-15s\t\n" $a
