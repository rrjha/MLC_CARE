...
cd /home/rakeshjha/MLC_CARE/cpu2006/benchspec/CPU2006/403.gcc/run/run_base_ref_my-alpha.0000/
/home/rakeshjha/MLC_CARE/gem5/build/ALPHA/gem5.opt --outdir=$OUTPUT_DIR/$var1 /home/rakeshjha/MLC_CARE/gem5/configs/example/se.py --simpoint-profile --simpoint-interval=200000000 --fastmem --cmd="gcc_base.my-alpha" --options="166.i -o 166.s"
date
