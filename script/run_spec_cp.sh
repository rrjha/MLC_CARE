...
/home/qizeng/gem5/build/ALPHA/gem5.opt ~/gem5/configs/example/se.py --cpu-type=atomic --num-cpus=4 --cpu-clock=3.2GHz --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=4MB --l1d_assoc=4 --l1i_assoc=4 --l2_assoc=8 --l3cache --l3_size=4MB --l3_assoc=32 --l3_tags=2 --cacheline_size=64 --mem-type=DDR3_1600_8x8 --mem-channels=2 --mem-size=8GB --at-instruction --checkpoint-dir=/home/qizeng/gem5/cpts --checkpoint-at-end --maxinsts=40400000000 --cmd="/home/qizeng/cpu2006/benchspec/CPU2006/429.mcf/run/run_base_ref_my-alpha.0000/mcf_base.my-alpha" --options="/home/qizeng/cpu2006/benchspec/CPU2006/429.mcf/run/run_base_ref_my-alpha.0000/inp.in"
date
